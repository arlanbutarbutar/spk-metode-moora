            <div class="form-panel">
              ...
              <form class="form-horizontal style-form" method="POST" action="kriteria/aksi_tambah.php">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Kode Kriteria</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control round-form" name="kode_kriteria">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" name="bobot" class="form-control round-form" min="0" step="0.001">
                  </div>
                </div>
                <div class="form-group">
