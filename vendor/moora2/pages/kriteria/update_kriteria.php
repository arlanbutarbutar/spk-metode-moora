...
?>
            ...
            <div class="form-panel">
              <h4 class="mb"><i class="fa fa-angle-right"></i> Update Kriteria</h4>
              <form class="form-horizontal style-form" method="POST" action="kriteria/aksi_update.php?id_kriteria=<?=$row['id_kriteria']?>">
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Kode Kriteria</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control round-form" name="kode_kriteria" value="<?=$row['kode_kriteria']?>" required>
                  </div>
                </div>
                <div class="form-group">
