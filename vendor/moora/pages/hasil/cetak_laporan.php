...
$conn = new mysqli("localhost","root","","db_moora");
$content ='
<style type="text/css">
...
$no=1;
$sql = $conn ->query("select * from tabel_hasil JOIN tabel_siswa ON tabel_hasil.id_siswa = tabel_siswa.id_siswa ORDER BY tabel_hasil.nilai");
